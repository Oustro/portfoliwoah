  ...
  return (
    ...
    >
      <Drawer.Trigger asChild>
        <button className="text-sm p-3 inline-block rounded-lg bg-slate-200 hover:bg-slate-300 transition cursor-pointer">Why Portfoliwoah?</button>
      </Drawer.Trigger>
      <Drawer.Portal>
        <Drawer.Overlay className="fixed inset-0 bg-black/40" />
          <Drawer.Content className="bg-white flex flex-col rounded-t-[10px] h-[96%] mt-24 fixed bottom-0 left-0 right-0">
            <div className="mx-auto w-full h-[85%] mt-8 overflow-auto pb-20">
              <h3 className="text-center text-3xl">Why Portfoliwoah?</h3>
